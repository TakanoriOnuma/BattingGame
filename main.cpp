...
void explain()
{
	...
	cout << "・加点されるスコアにはファール(foul)、ヒット(hit)、" << endl;
	cout << "　セカンドベースヒット(2hit)、ホームラン(homerun)があります。" << endl;
	cout << "・ファール(foul)は、ピンク色の線より外へ出るとファールとなり、加点は1点です。" << endl;
	cout << "・ヒット(hit)は、ピンク色の線の中で地面に当たるとヒットとなり、加点は2点です。" << endl;
	cout << "・セカンドベースヒット(2hit)は、地面に当たらずに先に壁に当たると" << endl;
	cout << "　セカンドベースヒットとなり、加点は3点です。" << endl;
	cout << "・ホームランは奥にある壁を越えるとホームランとなり、加点は4点です。" << endl;
	...
	cout << "○ゲームの処理系" << endl;
	cout << "　p:" << "ポーズする" << endl;
	cout << "　q:" << "ゲームを終了する(ESCでも終了できる)" << endl;
	cout << "○難易度調節系" << endl;
